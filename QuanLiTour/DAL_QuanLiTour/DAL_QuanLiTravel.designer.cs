...
namespace DAL_QuanLiTour
{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.CHITIETGIAVE")]
	public partial class CHITIETGIAVE : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<TOURDAT> _TOURDAT;
    ...
    partial void OnTHANHTIENChanged();
		...
		public CHITIETGIAVE()
		{
			this._TOURDAT = default(EntityRef<TOURDAT>);
		...
		public string MATOURDAT
		{
			...
			set
			{
				...
				{
					if (this._TOURDAT.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="TOURDAT_CHITIETGIAVE", Storage="_TOURDAT", ThisKey="MATOURDAT", OtherKey="MATOURDAT", IsForeignKey=true)]
		public TOURDAT TOURDAT
		{
			get
			{
				return this._TOURDAT.Entity;
			}
			set
			{
				TOURDAT previousValue = this._TOURDAT.Entity;
				if (((previousValue != value) 
							|| (this._TOURDAT.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._TOURDAT.Entity = null;
						previousValue.CHITIETGIAVEs.Remove(this);
					}
					this._TOURDAT.Entity = value;
					if ((value != null))
					{
						value.CHITIETGIAVEs.Add(this);
						this._MATOURDAT = value.MATOURDAT;
					}
					else
					{
						this._MATOURDAT = default(string);
					}
					this.SendPropertyChanged("TOURDAT");
				}
			}
		}
	...
	public partial class TOURDAT : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<DANHSACHNGUOIDIKEM> _DANHSACHNGUOIDIKEMs;
    ...
    partial void OnTONGTIENChanged();
		...
		public TOURDAT()
		{
			...
			this._DANHSACHNGUOIDIKEMs = new EntitySet<DANHSACHNGUOIDIKEM>(new Action<DANHSACHNGUOIDIKEM>(this.attach_DANHSACHNGUOIDIKEMs), new Action<DANHSACHNGUOIDIKEM>(this.detach_DANHSACHNGUOIDIKEMs));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="TOURDAT_CHITIETGIAVE", Storage="_CHITIETGIAVEs", ThisKey="MATOURDAT", OtherKey="MATOURDAT")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="TOURDAT_DANHSACHNGUOIDIKEM", Storage="_DANHSACHNGUOIDIKEMs", ThisKey="MATOURDAT", OtherKey="MATOURDAT")]
		public EntitySet<DANHSACHNGUOIDIKEM> DANHSACHNGUOIDIKEMs
		{
			get
			{
				return this._DANHSACHNGUOIDIKEMs;
			}
			set
			{
				this._DANHSACHNGUOIDIKEMs.Assign(value);
			}
		}
		...
		private void attach_DANHSACHNGUOIDIKEMs(DANHSACHNGUOIDIKEM entity)
		{
			this.SendPropertyChanging();
			entity.TOURDAT = this;
		}
		
		private void detach_DANHSACHNGUOIDIKEMs(DANHSACHNGUOIDIKEM entity)
		{
			this.SendPropertyChanging();
			entity.TOURDAT = null;
		}
    ...
    partial void OnGHICHUChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DIADIEMDULICH_CHITIETTHAMQUAN", Storage="_DIADIEMDULICH", ThisKey="MADIADIEM", OtherKey="MADIADIEM", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._DIADIEMDULICH.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.CHITIETTHAMQUANs.Remove(this);
					}
					this._DIADIEMDULICH.Entity = value;
					if ((value != null))
					{
						value.CHITIETTHAMQUANs.Add(this);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="TOUR_CHITIETTHAMQUAN", Storage="_TOUR", ThisKey="MATOUR", OtherKey="MATOUR", IsForeignKey=true)]
		public TOUR TOUR
		{
			get
			{
    ...
    partial void OnPASSPORTChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MATOURDAT", DbType="NChar(10) NOT NULL", CanBeNull=false)]
		public string MATOURDAT
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PASSPORT", DbType="NChar(10)")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="TOURDAT_DANHSACHNGUOIDIKEM", Storage="_TOURDAT", ThisKey="MATOURDAT", OtherKey="MATOURDAT", IsForeignKey=true)]
		public TOURDAT TOURDAT
		{
			get
			{
			...
			set
			{
							...
							|| (this._TOURDAT.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._TOURDAT.Entity = null;
						previousValue.DANHSACHNGUOIDIKEMs.Remove(this);
					}
					this._TOURDAT.Entity = value;
					if ((value != null))
					{
						value.DANHSACHNGUOIDIKEMs.Add(this);
						this._MATOURDAT = value.MATOURDAT;
					}
					else
					{
	...
	public partial class DIADIEMDULICH : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<CHITIETTHAMQUAN> _CHITIETTHAMQUANs;
    ...
    partial void OnTENDIADIEMChanged();
		...
		{
			this._CHITIETTHAMQUANs = new EntitySet<CHITIETTHAMQUAN>(new Action<CHITIETTHAMQUAN>(this.attach_CHITIETTHAMQUANs), new Action<CHITIETTHAMQUAN>(this.detach_CHITIETTHAMQUANs));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DIADIEMDULICH_CHITIETTHAMQUAN", Storage="_CHITIETTHAMQUANs", ThisKey="MADIADIEM", OtherKey="MADIADIEM")]
		public EntitySet<CHITIETTHAMQUAN> CHITIETTHAMQUANs
		{
			get
			{
				return this._CHITIETTHAMQUANs;
			}
			set
			{
				this._CHITIETTHAMQUANs.Assign(value);
			}
		}
		...
		private void attach_CHITIETTHAMQUANs(CHITIETTHAMQUAN entity)
		{
			this.SendPropertyChanging();
			entity.DIADIEMDULICH = this;
		}
		
		private void detach_CHITIETTHAMQUANs(CHITIETTHAMQUAN entity)
		{
			this.SendPropertyChanging();
    ...
    partial void OnGIAChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MALOAIKHACH", DbType="NChar(10) NOT NULL", CanBeNull=false)]
		public string MALOAIKHACH
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="LOAIKHACH_GIAVE", Storage="_LOAIKHACH", ThisKey="MALOAIKHACH", OtherKey="MALOAIKHACH", IsForeignKey=true)]
		public LOAIKHACH LOAIKHACH
		{
			get
			{
			...
			set
			{
							...
							|| (this._LOAIKHACH.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._LOAIKHACH.Entity = null;
						previousValue.GIAVEs.Remove(this);
					}
					this._LOAIKHACH.Entity = value;
					if ((value != null))
					{
						value.GIAVEs.Add(this);
						this._MALOAIKHACH = value.MALOAIKHACH;
					}
					else
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="TOUR_GIAVE", Storage="_TOUR", ThisKey="MATOUR", OtherKey="MATOUR", IsForeignKey=true)]
		public TOUR TOUR
		{
			get
			{
    ...
    partial void OnLICHKHOIHANH1Changed();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TENLICH", DbType="NVarChar(50)")]
	...
	public partial class LOAIKHACH : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<GIAVE> _GIAVEs;
    ...
    partial void OnDOTUOIChanged();
		...
		{
			this._CHITIETGIAVEs = new EntitySet<CHITIETGIAVE>(new Action<CHITIETGIAVE>(this.attach_CHITIETGIAVEs), new Action<CHITIETGIAVE>(this.detach_CHITIETGIAVEs));
			this._GIAVEs = new EntitySet<GIAVE>(new Action<GIAVE>(this.attach_GIAVEs), new Action<GIAVE>(this.detach_GIAVEs));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="LOAIKHACH_GIAVE", Storage="_GIAVEs", ThisKey="MALOAIKHACH", OtherKey="MALOAIKHACH")]
		public EntitySet<GIAVE> GIAVEs
		{
			get
			{
				return this._GIAVEs;
		...
		private void attach_GIAVEs(GIAVE entity)
		{
			this.SendPropertyChanging();
			entity.LOAIKHACH = this;
		}
		
		private void detach_GIAVEs(GIAVE entity)
		{
			this.SendPropertyChanging();
			entity.LOAIKHACH = null;
		}
    ...
    partial void OnHINHChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="TOUR_CHITIETTHAMQUAN", Storage="_CHITIETTHAMQUANs", ThisKey="MATOUR", OtherKey="MATOUR")]
		public EntitySet<CHITIETTHAMQUAN> CHITIETTHAMQUANs
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="TOUR_GIAVE", Storage="_GIAVEs", ThisKey="MATOUR", OtherKey="MATOUR")]
		public EntitySet<GIAVE> GIAVEs
		{
			get
			{
